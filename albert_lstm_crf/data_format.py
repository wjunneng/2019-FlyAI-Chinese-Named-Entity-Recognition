...
class DataFormat():
    def __init__(self, max_length=100, batch_size=20, data_type='train'):
        ...
        self.train_data = []
        self.tag_map = {label: i for i, label in enumerate(args.labels)}

        base_path = os.path.abspath(os.path.join(os.getcwd(), "../.."))
        if data_type == "train":
            self.data_path = base_path + '/albert_lstm_crf/data/ner_data/train/'
        elif data_type == "dev":
            self.data_path = base_path + "/albert_lstm_crf/data/ner_data/dev/"
        elif data_type == "test":
            self.data_path = base_path + "/albert_lstm_crf/data/ner_data/test/"
    ...
    def read_corpus(self, train_file_data, train_file_tag, max_length, label_dic):
        ...
        with open(train_file_data, 'r', encoding='utf-8') as file_train, open(train_file_tag, 'r',
                                                                              encoding='utf-8') as file_tag:
